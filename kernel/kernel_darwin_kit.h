...
extern kern_return_t mac_rootkit_start(IOKernelDarwinKitService* service, xnu::Kernel* kernel,
                                       xnu::Kext** kext);
extern kern_return_t mac_rootkit_stop(IOKernelDarwinKitService* service, xnu::Kernel* kernel,
                                      xnu::Kext** kext);

extern darwin::DarwinKit* mac_rootkit_get_rootkit();
