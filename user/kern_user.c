...
void kcov_enable_coverage() {
	...
	uint64_t output[] = {};
	uint32_t outputCnt = 0;
	kr = IOConnectCallMethod(connection, kIOKernelDarwinKitEnableCoverage, input, 0, 0, 0, output, &outputCnt, 0, 0);
}
...
void kcov_disable_coverage() {
	...
	uint64_t output[] = {};
	uint32_t outputCnt = 0;
	kr = IOConnectCallMethod(connection, kIOKernelDarwinKitDisableCoverage, input, 0, 0, 0, output, &outputCnt, 0, 0);
}
